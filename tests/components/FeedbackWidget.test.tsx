...
describe("FeedbackWidget", () => {
  ...
  it("opens the feedback dialog from the header button", async () => {
    ...
    expect(screen.getByText("Did you find what you needed?")).toBeInTheDocument();
  });
  ...
  it("submits a sentiment and comment to /feedback/", async () => {
    ...
    await userEvent.type(screen.getByPlaceholderText(/what were you looking for/i), "Great tool!");

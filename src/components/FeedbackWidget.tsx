    ...
    <Dialog.Root open={open} onOpenChange={handleOpenChange}>
      <Dialog.Trigger asChild>
        ...
        >
          ...
          <span className="text-xs text-grey-med leading-none whitespace-nowrap">Feedback</span>
        </button>
      </Dialog.Trigger>
      <Dialog.Portal>
        ...
        >
          <div className="flex items-start justify-between gap-2 mb-4">
            <div>
              <Dialog.Title className="text-base font-semibold text-grey-dark">Did you find what you needed?</Dialog.Title>
              <Dialog.Description className="text-xs text-grey mt-0.5">
                Tell us what you were trying to find and how it went.
              </Dialog.Description>
            </div>
          ...
          {status === "submitted" ? (
            <div className="space-y-4">
              ...
              <button
                onClick={reset}
                className="w-full py-2 rounded-md border border-grey-light text-sm font-medium text-grey-dark hover:bg-grey-lighter transition-colors"
              >
                Submit another
              </button>
            </div>
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                placeholder="What were you looking for, and did this help you find it? (optional)"
                rows={3}
